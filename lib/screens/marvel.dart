...
class _MarvelPageState extends State<MarvelPage> {
  final CollectionReference marvelPage =
      FirebaseFirestore.instance.collection('marvelPage');
  ...
  void _createInterstitialAd() {
    InterstitialAd.load(
      adUnitId: AdmobService.interstitialAdUnitId1,
      request: AdRequest(),
                  ...
                  child: Center(
                    ...
                    children: [
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) =>
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20),
                                image: DecorationImage(
                                    image: NetworkImage(imgList2[index]),
                                    fit: BoxFit.cover)),
                          ),
                        ),
                      ),
                      //Ads
                        ...
                        //   height: 50,
                        //   child: AdWidget(
                        //     ad: AdmobService.createBannerAd1()..load(),
                        //     key: UniqueKey(),
                        //     ),
                        // ),
                      Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) =>
                            ...
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(20),
                                image: DecorationImage(
                                    image: NetworkImage(ranking2[index]),
                                    fit: BoxFit.cover)),
                          ),
                        ),
                      ),
                      ...
                      Container(
                          width: 95.w,
                          height: 15.h,
                          margin: const EdgeInsets.only(top: 17, bottom: 90),
                          alignment: Alignment.center,
                          decoration: BoxDecoration(
